...
<div id="htmlwidget_container">
  <div class="sankeyNetwork html-widget html-fill-item" id="htmlwidget-c065acdf38484a8eaab0" style="width:960px;height:500px;"></div>
</div>
<script type="application/json" data-for="htmlwidget-c065acdf38484a8eaab0">{"x":{"links":{"source":[1,1,0,0,0,2,4,4,4,3,3,3,5,5],"target":[4,3,4,3,5,3,6,7,8,6,7,8,6,7],"value":[2,435,62,234,3,115,18,42,4,354,336,94,2,1]},"nodes":{"name":["Economic","Ecological","Public Health","Negative","Both","Positive","Maximum Control","Limited Control","Fail"],"group":["Economic","Ecological","Public Health","Negative","Both","Positive","Maximum Control","Limited Control","Fail"]},"options":{"NodeID":"name","NodeGroup":"name","LinkGroup":null,"colourScale":"d3.scaleOrdinal()\n  .range([\"#3A9AB2\", \"#6FB2C1\", \"#91BAB6\", \"#A5C2A3\", \n          \"#BDC881\", \"#DCCB4E\", \"#E3B710\",\"#E79805\", \n          \"#EC7A05\", \"#EF5703\", \"#F11B00\"])","fontSize":25,"fontFamily":null,"nodeWidth":40,"nodePadding":20,"units":"","margin":{"top":null,"right":null,"bottom":null,"left":null},"iterations":32,"sinksRight":false}},"evals":[],"jsHooks":[]}</script>
<script type="application/htmlwidget-sizing" data-for="htmlwidget-c065acdf38484a8eaab0">{"viewer":{"width":450,"height":350,"padding":10,"fill":true},"browser":{"width":960,"height":500,"padding":10,"fill":true}}</script>
</body>
</html>
